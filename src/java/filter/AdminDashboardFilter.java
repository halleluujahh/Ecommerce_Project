...
public class AdminDashboardFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (account == null && req.getRequestURI().equals(req.getContextPath() + "/admin/manageproduct")) {
            ...
            } else if (account.getRole_Id() == Constant.ROLE_SELLER && account.getRole_Id() != Constant.ROLE_ADMIN && !req.getRequestURI().equals(req.getContextPath() + "/error?page=seller403")) {
                resp.sendRedirect(req.getServletContext().getContextPath() + "/error?page=seller403");
            } else if (account.getRole_Id() == Constant.ROLE_CUSTOMER && account.getRole_Id() != Constant.ROLE_ADMIN && !req.getRequestURI().equals(req.getContextPath() + "/error?page=403")) {
