...
<html lang="en">
    ...
    <head>
        ...
        <title>Checkout 3rd Step Page - Brava</title>
            ...
            <section class="checkout_section sec_ptb_140 clearfix">
                <div class="container">
                    ...
                    <ul class="checkout_step ul_li clearfix">
                        <li class="activated"><a><span>01.</span>View Shopping Cart</a></li>
                        <li class="activated"><a><span>02.</span> Checkout</a></li>
                        <li class="active"><a href="${pageContext.request.contextPath}/Checkout?page=checkoutstep3"><span>03.</span> Order Completed</a></li>
                    </ul>

                    <div class="order_complete_alart text-center">
                        <h2>Congratulation! You’ve <strong>Completed</strong> Payment.</h2><br>
                    </div>
                    <button type="submit" class="btn-block custom_btn bg_default_red text-uppercase mb_50"><a href="${pageContext.request.contextPath}/home" style="color: white;" >Back to Home Page</a></button> <!--href="/home"-->
                </div>
            </section>
