                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/seller/manageProduct?page=view-product-details&productID=${productForm.id}&colorID=${productForm.color_id}&categoryID=${productForm.category_id}&sizeID=${productForm.size_id}&brandID=${productForm.brand_id}&genderID=${productForm.gender_id}">Details</a>
                                        </li>
                    ...
                    <section class="app-ecommerce-details">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="updateProductForm" action="${pageContext.request.contextPath}/seller/manageProduct?action=updateProduct" method="POST" enctype="multipart/form-data">
                                    <div class="row mb-5 mt-2">
                                        <div class="col-md-6">
                                            <div class="form-group" style="display: none">
                                                <input type="text" class="form-control" id="productid" name="productID" value="${productForm.id}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="productpriceInput1" name="productPrice" value="${price}">
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <c:forEach items="${listImages}" var="image">
                                                <div style="position: relative; display: inline-block;">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/seller/manageProduct?page=delete-images-product&imagesID=${image.product_Id}&imagePath=${image.image}" style="position: absolute; top: 5px; right: 5px;">
                                                        <!-- X icon -->
        ...
        <jsp:include page="../seller/logOutModal.jsp"></jsp:include> 
            <script>
                ...
                function validateUpdateProductForm() {
                    ...
                    } else if (!/^(?!.*\s{2})[A-Za-z0-9-\s]+$/.test(productName1)) {
                    ...
                    if (productDescription1 === '') {
                        ...
                        $('#productdescriptionError1').html('Product Description must contain only letters, numbers, and special characters');
                    }
