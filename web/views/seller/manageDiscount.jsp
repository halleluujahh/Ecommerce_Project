...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-shopping-bag"></i><span class="menu-title" data-i18n="Ecommerce">Product</span></a>
                        <ul class="menu-content">
                            ...
                            <li class="active"><a href="${pageContext.request.contextPath}/seller/dashboard?page=setting-discounts"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Setting Discounts</span></a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/seller/dashboard?page=setting-discounts">List Discount</a>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listD}" var="d">
                                                            <tr style="color:black">
                                                                ...
                                                                <td>${d.quantity}</td>
                                                                <td>
                                                                    <button onclick="editQuantityDiscountModal('${d.id}')" class="btn btn-success" type="button" data-toggle="modal" data-target="#settingDiscountModal">
                                                                        <i class="fas fa-edit mr-2">Setting Quantity</i> 
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
        ...
        <jsp:include page="../../views/seller/editQuantityDiscount.jsp"></jsp:include>
    </body>
    <!-- END: Body-->
