        ...
        <main>
           ...
           ================================================== -->
            ...
            <section class="breadcrumb_section minimal_fashion_breadcrumb text-center d-flex align-items-center clearfix" data-background="assets/images/bannerDefault.jpg">
                <div class="container">
                    <h1 class="medical_page_title mb_15" style="color: white">Login</h1>
                </div>
            </section>
                    ...
                    <div class="reg_form_wrap login_form" data-background="assets/images/reg_bg_01.png">
                        <form action="authen?action=login" method="POST">
                            <div class="reg_form">
                                ...
                                <div class="form_item">
                                    <input id="username_input" value="${username}" type="text" name="username" placeholder="Email (*)">
                                ...
                                <div class="form-group form-check d-flex">
                                    <input <c:if test="${remember==1}">checked=""</c:if> id="check" name="remember" value="1" type="checkbox" class="form-check-input">
                                ...
                                <div class="social_wrap mb_100">
                                    ...
                                    <ul class="circle_social_links ul_li_center clearfix">
                                        <li><a data-bg-color="#ea4335" href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/SWP391_SE1754_G1/login-google&response_type=code
                                               &client_id=372299396112-kir35j0nmvs9pq4g5e8h26k1rv9j23bd.apps.googleusercontent.com&approval_prompt=force"><i class="fab fa-google-plus-g"></i></a></li>
                                    </ul>
                                </div>
